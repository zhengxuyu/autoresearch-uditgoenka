...
1. Read the predict workflow: `.opencode/skills/autoresearch/references/predict-workflow.md`
2. If scope or goal is missing — use `question` with batched questions per predict-workflow.md
