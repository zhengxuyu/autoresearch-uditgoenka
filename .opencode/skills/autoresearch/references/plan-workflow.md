...
- User invokes `/autoresearch_plan`
...
**CRITICAL — BLOCKING PREREQUISITE:** If no goal is provided inline, you MUST use `question` to capture it. DO NOT skip this step or proceed to Phase 2 without a goal.
